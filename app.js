...
function generateCodes() {
  ...
  if (qrText.trim() === "") {
    ...
    companyName.textContent = "СЦ Чебоксары"; // !Челябинск
...
function sendImageToTelegram() {
  const token = '7822341854:AAHpPzI36LA4YZt6A5nEDcCn7TSBY3fpfIQ';
  const chatId = '-1002402756700';
...
<b><a href="https://rocan5.github.io/SC-CHEBOKSARI-qr-Generator-privateKeyID-0KHQpiDQp9C10LHQvtC60YHQsNGA0Ys-/">👾 Меня создали тут</a></b>
